...
if (url.searchParams.get('sayang') != null) {
  sender = url.searchParams.get('sayang');
} else {
  sender = "winda";
}
...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Pacarku", "Aku ada pertanyaan nih buat kamu masssss", "question").then(function () {
      ...
      Swal.fire("Awas aja kalau kamu bohong", "", "error").then(function () {
        ...
        const {
          ...
          inputValidator: (value) => {
            if (!value) {
              return 'Isi dulu dong sayangggg'
            } else {
              nama = value;
            }
          }
